...
{
	std::cout << "Form's constructor with parameters called" << std::endl;
...
Form::Form(const Form &other) : name(other.name), is_signed(other.is_signed), grade_s(other.grade_s), grade_e(other.grade_e)
{
